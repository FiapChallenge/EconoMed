  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: COLORS.white }}>
      <View style={styles.container}>
        ...
        <HomeCardContainer />
        <HomeSectionContainer title="ACESSO RÁPIDO">
          <HomeFastAcessCard
            nome="hospitais"
            icon={Marker}
            link="/(tabs)/units"
          ...
          <HomeFastAcessCard nome="artigos" icon={Search} />
          <HomeFastAcessCard nome="perfil" icon={User} link="/(tabs)/perfil" />
        </HomeSectionContainer>
        <HomeSectionContainer title="ÚLTIMAS CONSULTAS" direction="column">
