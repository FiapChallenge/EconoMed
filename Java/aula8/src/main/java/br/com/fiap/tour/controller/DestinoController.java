...
public class DestinoController {
    ...
    @PostMapping
    @Transactional
    public ResponseEntity<DetalhesDestinoDTO> cadastrar(@RequestBody @Valid CadastroDestinoDTO dto,
    ...
    @PutMapping("/{id}")
    @Transactional
    public ResponseEntity<DetalhesDestinoDTO> atualizar(@PathVariable("id") Long id,
            @RequestBody @Valid AtualizacaoDestinoDTO dto) {
