...
public class ClienteController {
    ...
    public ResponseEntity<Page<DetalhesClienteDTO>> buscarPorEstados(@RequestParam("uf") List<String> estados,
            Pageable pageable) {
    ...
    public ResponseEntity<Page<DetalhesClienteDTO>> buscarPorPrecoPacote(@RequestParam("valor") Double valor,
            Pageable pageable) {
    ...
    @PostMapping
    @Transactional
    public ResponseEntity<DetalhesClienteDTO> cadastrar(@RequestBody @Valid CadastroClienteDTO dto,
    ...
    @PutMapping("/{id}")
    @Transactional
    public ResponseEntity<DetalhesClienteDTO> atualizar(@PathVariable("id") Long id,
